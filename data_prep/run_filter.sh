#!/bin/sh
audio_dir="/content/drive/MyDrive/Clean"
output_dir="/content/drive/MyDrive/Clean_filtered"
...
for book in $books; do
   python3 run_filter.py --audio_dir $audio_dir/$book --output_dir $output_dir --log_file $output_dir --history_file $output_dir
done
