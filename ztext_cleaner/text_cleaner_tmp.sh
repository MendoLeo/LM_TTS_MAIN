...
texts_dir="/home/mendo/Downloads/LM/LM-5/LM-TTS-Main/tc_data/filtered_Ewo"
json_file="/home/mendo/Downloads/LM/LM-5/LM-TTS-Main/tc_data/json"
...
for book in $books; do
   ...
   python3 text_cleaner_tmp.py --texts_dir $texts_dir/$book --json_file $json_file/$book.json 
done
